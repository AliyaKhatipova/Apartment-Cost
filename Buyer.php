  ...
  <div class="container">
    <div class="nav-row">
      ...
      <ul class="nav-list">
        ...
        <li class="nav-list__item"><a href="Buyer.html" class="nav-list__link nav-list__link--active">Покупка недвижимости</a></li>
    ...
    <header class="header">
      <div class="header__wrapper">
        <h1 class="header__title">
          Здесь вы можете проверить стоимость квартиры перед покупкой!
        </h1>
        <div class="header__text">
          <p>Нужно будет лишь выбрать характеристики квартиры, зато не придется переплачивать!</p>
        </div>
      </div>
    </header>
