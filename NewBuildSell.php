  ...
  <div class="container">
    <div class="nav-row">
      ...
      <ul class="nav-list">
        ...
        <li class="nav-list__item"><a href="Seller.php" class="nav-list__link nav-list__link--active">Продажа недвижимости</a></li>
...
<main class="calc-wrapper">
  <div class="container">
    <form id="form">
      ...
      <!-- Сроки -->
      <div class="calc-section">
        <h4 class="checkbox-wrapper title-bold section-title">Выбери сроки за которые необходимо продать квартиру</h4>
        <label class="radio-wrapper" data-name="mobile">
          <input type="radio" class="radio" name="time" value="-1000000"  />
          <div class="title-lite">
            Меньше двух месяцев
            <span class="note">До 15 минут пешком</span>
          </div>
        ...
        <label class="radio-wrapper" data-name="mobile">
          <input type="radio" class="radio" name="time" value="-700000"  />
          <div class="title-lite">
        ...
        <label class="radio-wrapper" data-name="mobile">
          <input type="radio" class="radio" name="time" value="0"  />
          <div class="title-lite">
        ...
        <label class="radio-wrapper" data-name="mobile">
          <input type="radio" class="radio" name="time" value="500000"  />
          <div class="title-lite">
            От семи до года
            <span class="note">До 15 минут пешком</span>
          </div>
